...
client.on('ready', () => {
    client.user.setPresence({ game: { name: "Caxi <3 | w!help", type: 0} });
...
client.on('message', message => {
    ...
    if (message.content === prefix + "serveurinfos"){
        var help_embed = new Discord.RichEmbed()
            .setColor('#98B0E9')
            .addField("Infos sur la PixelTeam :notepad_spiral:","__Créateur__\rUltimate#5669\r\r__Members__\r40")
        message.channel.sendEmbed(help_embed)
        //message.channel.sendMessage("tu veux voir ma bite ?")
    }
    ...
    if (message.content === prefix + "profile"){
	    ...
	    .setDescription("**Voiçi ton avatar**>:reminder_ribbon:\r```----------->```")
        message.channel.sendEmbed(help_embed)
        //message.channel.sendMessage("tu veux voir ma bite ?")
    }
